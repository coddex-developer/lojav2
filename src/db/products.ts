...
export const products: ProductType[] = [
    {
        ...
        pricing: { basePrice: 3.50, isPromotional: true, discountPercentage: 10, finalPrice: 0 },
        variants: []
    },
    {
        id: 2,
        ...
        inventory: { isInStock: true, stockQuantity: 30 },
        media: { images: ["/images_products/esponjosoweb.jpg"], thumbnailUrl: "" },
        pricing: { basePrice: 39.90, isPromotional: false, discountPercentage: 10, finalPrice: 0 },
        variants: []
    },
    {
        id: 3,
